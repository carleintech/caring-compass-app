...
-- CreateEnum
CREATE TYPE "CareRequestStatus" AS ENUM ('PENDING', 'CONTACTED', 'ASSESSMENT_SCHEDULED', 'ASSESSMENT_COMPLETED', 'CARE_PLAN_CREATED', 'SERVICE_STARTED', 'CANCELLED', 'CLOSED');
...
-- CreateIndex
CREATE INDEX "appointments_caregiverId_idx" ON "appointments"("caregiverId");
...
-- AddForeignKey
ALTER TABLE "appointments" ADD CONSTRAINT "appointments_caregiverId_fkey" FOREIGN KEY ("caregiverId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
